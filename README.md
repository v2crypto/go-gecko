...
[![Build Status](https://travis-ci.com/v2crypto/go-gecko.svg?branch=master)](https://travis-ci.com/v2crypto/go-gecko) [![GoDoc](https://godoc.org/github.com/v2crypto/go-gecko?status.svg)](https://godoc.org/github.com/v2crypto/go-gecko)
...
```
go get -u github.com/v2crypto/go-gecko
```
...
import (
	...
	coingecko "github.com/v2crypto/go-gecko/v3"
)
